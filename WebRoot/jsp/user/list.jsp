  ...
  <head>
	...
	<script type="text/javascript">
			...
			$(function() {
				$dg = $("#dg");
				$grid=$dg.datagrid({
					url : "${pageContext.request.contextPath}/admin/user/list.shtml",
					width : 'auto',
					height :  $(this).height(),
					pagination:true,
					rownumbers:true,
			...
			function delRows(){
				...
				if(row){
					...
					$dg.datagrid('deleteRow', rowIndex);
					$.ajax({
						url:"${pageContext.request.contextPath}/admin/user/del.shtml",
						data: "id="+row.id,
			...
			function updRowsOpenDlg() {
				...
				if (row) {
					parent.$.modalDialog({
						...
						width : 600,
						height : 400,
						href : "${pageContext.request.contextPath}/jsp/user/edit.jsp",
						onLoad:function(){
