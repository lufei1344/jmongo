		...
		<script type="text/javascript">
			...
			$(function() {
				 ...
				 $grid=$dg.treegrid({
					width : 'auto',
					height : $(this).height(),
					url : "${pageContext.request.contextPath}/admin/organization/list.action",
					rownumbers:true,
					animate: true,
					collapsible: true,
					fitColumns: true,
			...
			function delRows(){
				...
				if(node){
					parent.$.messager.confirm("提示","确定要删除记录吗?",function(r){  
					    if (r){  
							$.post("${pageContext.request.contextPath}/admin/organization/del.action", {id:node.id}, function(rsp) {
								if(rsp.status){
			...
			function updRowsOpenDlg() {
				...
				if (row) {
					parent.$.modalDialog({
						...
						width : 600,
						height : 400,
						href : "${pageContext.request.contextPath}/jsp/organization/edit.jsp",
						onLoad:function(){
