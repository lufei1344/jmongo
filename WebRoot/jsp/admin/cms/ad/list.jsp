  ...
  <head>
	...
	<script type="text/javascript">
			...
			$(function() {
				$dg = $("#dg");
				$grid=$dg.datagrid({
					url : "${pageContext.request.contextPath}/admin/cms/ad/list.action",
					width : 'auto',
					height :  $(this).height(),
					pagination:true,
					rownumbers:true,
					...
					singleSelect:true,
					striped:true,
					columns : [ [ {field : 'id',title : '编码',width : parseInt($(this).width()*0.1),align : 'left',editor : "text"},
					              ...
					              {field : 'text',title : '内容',width : parseInt($(this).width()*0.1),editor : "text"},
					              {field : 'script',title : '脚本',width : parseInt($(this).width()*0.1),align : 'left',editor : {type:'validatebox',options:{required:true,validType:'email'}}},
					              {field : 'image',title : '图片',width : parseInt($(this).width()*0.1),align : 'left',editor : "text"},
					              {field : 'flash',title : 'Flash',width : parseInt($(this).width()*0.1),align : 'left',editor : "text"}
					              ] ],toolbar:'#tb'
				});
				//搜索框
				$("#searchbox").searchbox({ 
			...
			function delRows(){
				...
				if(row){
					...
					$dg.datagrid('deleteRow', rowIndex);
					$.ajax({
						url:"${pageContext.request.contextPath}/admin/cms/ad/del.action",
						data: "id="+row.id,
			...
			function updRowsOpenDlg() {
				...
				if (row) {
					parent.$.modalDialog({
						...
						width : 600,
						height : 400,
						href : "${pageContext.request.contextPath}/jsp/cms/ad/edit.jsp",
						onLoad:function(){
