  ...
  <head>
	...
	<script type="text/javascript">
			...
			$(function() {
				$dg = $("#dg");
				$grid=$dg.datagrid({
					url : "${pageContext.request.contextPath}/admin/cms/article/list.action",
					width : 'auto',
					height :  $(this).height(),
					pagination:true,
					rownumbers:true,
			...
			function delRows(){
				...
				if(row){
					...
					$.ajax({
						url:"${pageContext.request.contextPath}/admin/cms/article/del.shtml",
						data: "id="+row.id,
			...
			function updRowsOpenDlg() {
				...
				if (row) {
					parent.$.modalDialog({
						...
						width : 600,
						height : 400,
						href : "${pageContext.request.contextPath}/jsp/cms/article/edit.jsp",
						onLoad:function(){
