...
<script type="text/javascript">
	$(function() {
		...
		$("#form").form({
			url :"${pageContext.request.contextPath}/admin/cms/adslot/edit.action",
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 10px;">
		<form id="form" method="post">
			<fieldset>
				<legend><img src="extend/fromedit.png" style="margin-bottom: -3px;"/> 广告位编辑</legend>
				<input name="id" id="id"  type="hidden"/>
				 <table>
					 ...
					 <tr>
						...
						<th>数量</th>
						<td><input id="number" name="number" type="text" class="easyui-textbox easyui-validatebox"  required="required" /></td>
					 </tr>
					  <tr>
					    <th>宽度</th>
					 ...
					 <tr>
						<th>模板</th>
						<td colspan="3"><textarea class="easyui-textbox" name="template"  style="width: 435px;height: 100px;"></textarea></td>
					</tr>
					 <tr>
						<th>描述</th>
