  ...
  <head>
	...
	<script type="text/javascript">
			...
			$(function() {
				$dg = $("#dg");
				$grid=$dg.datagrid({
					url : "${pageContext.request.contextPath}/admin/cms/adslot/list.shtml",
					width : 'auto',
					height :  $(this).height(),
					pagination:true,
					rownumbers:true,
					...
					columns : [ [ {field : 'id',title : '用户编码',width : parseInt($(this).width()*0.1),align : 'left',editor : "text"},
					              ...
					              {field : 'number',title : '数量',width : parseInt($(this).width()*0.1),editor : {type:'validatebox',options:{required:true}}},
					              {field : 'width',title : '宽度',width : parseInt($(this).width()*0.1),editor : "validatebox"},
					              {field : 'height',title : '高度',width : parseInt($(this).width()*0.1),align : 'left',editor : {type:'validatebox',options:{required:true,validType:'email'}}},
					              {field : 'template',title : '模板',width : parseInt($(this).width()*0.1),align : 'left',editor : "text"},
			...
			function delRows(){
				...
				if(row){
					...
					$.ajax({
						url:"${pageContext.request.contextPath}/admin/cms/adslot/del.shtml",
						data: "id="+row.id,
			...
			function updRowsOpenDlg() {
				...
				if (row) {
					parent.$.modalDialog({
						...
						width : 600,
						height : 400,
						href : "${pageContext.request.contextPath}/jsp/cms/adslot/edit.jsp",
						onLoad:function(){
