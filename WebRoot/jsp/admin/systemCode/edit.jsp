...
<script type="text/javascript">
	$(function() {
		$("#pid").combotree({
			width:171,
			url:"${pageContext.request.contextPath}/admin/systemcode/findall.action",
			idFiled:'id',
		 	textFiled:'name',
		 	parentField:'pid',
		});
		...
		$("#form").form({
			url :"${pageContext.request.contextPath}/admin/systemcode/edit.action",
			onSubmit : function() {
			...
			<fieldset>
				...
				<input name="codePid" id="codePid"  type="hidden"/>
				 <table>
					 <tr>
					    <th>词典名称</th>
						<td colspan="3"><input name="name" id="name" placeholder="请输入词典名称" class="easyui-textbox easyui-validatebox" type="text" /></td>
					 </tr>
					 <tr>
					 	<th>父词典名称</th>
