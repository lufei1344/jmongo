...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function initMenu(){
			...
			$.post("${pageContext.request.contextPath}/admin/menu/leftmenu.shtml", {userName:"1"}, function(rsp) {
 ...
 <body class="easyui-layout">
	...
	<!-- 
	<div data-options="region:'center',plain:true,title:'欢迎使用'" style="overflow: hidden;"  href="layout/center.jsp"></div>
	 -->
