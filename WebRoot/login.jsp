  ...
  <body>
	...
	<div id="login">
		...
		<div class="inner">
			...
			<div class="formLogin">
				<form name="formLogin" action="${pageContext.request.contextPath}/login.shtml" id="formLogin" method="post">
					<input name="userKey" type="hidden" id="userKey" value="D1B5CC2FE46C4CC983C073BCA897935608D926CD32992B5900" />
					<div class="tip">
						<input class="userName" name="account" type="text" id="account" title="用户名" iscookie="true" value="admin" nullmsg="请输入用户名!" />
					</div>
					<div class="tip">
